          ...
          <SwiperSlide>
            <div className="relative">
              ...
              <div className="absolute top-[54%] left-2 lg:left-6 xl:bottom-16 xl:top-[unset] transform w-[70%] lg:w-[50%]">
                <h5 className="font-rubik font-semibold text-2xl text-[var(--color-white)] lg:text-5xl">
                  NIKE AIR MAX
                </h5>
                <p className="font-open-sans text-[var(--color-light-gray)] text-[16px] lg:text-[18px]">
