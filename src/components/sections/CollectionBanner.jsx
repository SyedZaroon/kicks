  ...
  return (
    <>
      <div className="relative">
        <Image
          src={BannerImage}
          alt="mensCollectionBanner"
          className=" min-h-[149px] object-cover rounded-2xl lg:rounded-4xl"
        />
        <div className="text-light-gray flex flex-col max-w-[95%] absolute bottom-[10%] left-[10px] lg:left-[20px] lg:bottom-[20%] lg:max-w-[49%] xl:max-w-[40%] lg:gap-2">
