  ...
  return (
    <div className={`bg-white rounded-lg p-4 lg:p-6 ${className}`}>
      <div className="space-y-6">
        {/* Header */}
        <div>
          <h2 className="h3 text-dark-gray mb-2">Order Summary</h2>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <span className="text-gray font-medium">Delivery</span>
          ...
          {tax > 0 && (
            <div className="flex items-center justify-between">
              <span className="text-gray font-medium">Sales Tax</span>
              <span className="text-dark-gray font-semibold">
                ${tax.toFixed(2)}
              </span>
            </div>
        ...
        {/* Total */}
        <div className="flex items-center justify-between">
          <span className="h4 text-dark-gray font-semibold">Total</span>
          <span className="h4 text-dark-gray font-bold">
            ${total.toFixed(2)}
          </span>
        </div>
