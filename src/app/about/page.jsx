    ...
    <div className="w-full flex mt-2 mb-8 flex-col gap-8 xl:flex-row xl:my-16 xl:gap-0 xl:w-[90%]">
      ...
      <div>
        ...
        <p className='font-open-sans text-[var(--color-dark-gray)]  text-[16px]'>
          ...
          gadgets—quickly, safely, and transparently. In a digital world full of
          options, we make it easy to compare verified buyers, lock in the best
          price, and get paid fast.
        </p>
        </div>
